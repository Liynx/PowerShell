...
foreach($line in $file) {
        ...
        $fullPath = "\\powerdc\ShareV3$\user{0}" -f $uNameLower
        $drive = "H:\"
...
#Get-ADUser -Filter * -SearchBase "OU=Group 1,DC=powerdc,DC=com" | ForEach-Object {
#    $sam = $_SamAccountName
#    write-host $sam
#    Set-ADUser -Identity $_ -HomeDrive "H:" -HomeDirectory "\\powerdc\ShareV3$\$sam"
#}
